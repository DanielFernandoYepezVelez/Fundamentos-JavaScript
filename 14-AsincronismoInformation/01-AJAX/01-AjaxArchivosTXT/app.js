...
/* FORMA NUEVA O MODERNA DE HACER PETICIONES AJAX*/
...
function peticionAjax() {
    ...
    /* 3. Una Vez Que Carga La Pagina, Renderiza La informacion Si no tiene problemas. Aqui le decimos que debe hacer con los datos en el cliente */
    xhr.onload = function() {
    ...
    /* 4. Enviar el request o la peticion al servidor */
    xhr.send();
}


/* FORMA ANTIGUA DE HACER UNA PETICION TIPO AJAX */
...
/* 4. Enviar el request o la peticion*/
// xhr.send();
// }